...
public class SliderTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.slider_two, null);
        mContext = getActivity();
        logo = root.findViewById(R.id.logo);
        tv_appname = root.findViewById(R.id.tv_appname);
        tv_msg_2 = root.findViewById(R.id.tv_msg_2);
        tv_msg_2.setText(Html.fromHtml("Tag your products to Events like a<br><p>gun show or trade show to help</p><p>generate more leads.</p>"));
